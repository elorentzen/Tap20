...
class Car:
    ...
    def __init__(self):
        ...
        :param self: the instance of this object, used to construct.
        :type self: Car
        """
        self.type = ""
        self.model = ""
...
class BMW(Car):
    def __init__(self, **arg):
        ...
        :param type: The type of car. Should be part of arg. Key is "type".
        :type type: str

        :param doors: The doors of the car. Should be part of arg. Key is "doors".
        :type doors: int
...
class Fuel:
    ...
    def __init__(self, **arg):
        ...
        :param liters: How many liters the car needs
        :type liter: int

        :param type: What type of fuel the car needs
        :type type: str
        """
